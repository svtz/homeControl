...
{
    public abstract class SensorViewModelBaseOfT<T> : SensorViewModelBase, IDisposable
    {
        ...
        protected SensorViewModelBaseOfT(
            ...
            : base(log)
        {
            ...
            Log.Debug("Вьюмодель датчика создана.");
        }
        ...
        protected abstract T GetValueFromEvent(AbstractSensorEvent e);
        protected abstract IEnumerable<AbstractSensorEvent> GetEventsFromValue(T value);

        private void UpdateValueFromEvent(AbstractSensorEvent e)
        {
