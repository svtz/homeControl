...
namespace homeControl.Tests.Controller
{
    public class BindingEventsProcessorTests
    {
        ...
        public void Test_WhenReceivedEnableEvent_ThenEnableBinding()
        {
            ...
            eventReceiverMock.Setup(e => e.ReceiveEvents<AbstractBindingEvent>()).Returns(Observable.Repeat(@event, 1));
            var handler = new BindingEventsProcessor(stateManagerMock.Object, eventReceiverMock.Object, Mock.Of<ILogger>());
